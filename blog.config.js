...
const BLOG = {
  AUTHOR: 'Kingstar', // 作者
  BIO: '一个普通的编码工具人🍚', // 作者简介
  LINK: 'https://www.ikingstar.tk', // 网站地址
  KEYWORDS: 'Kingstar, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '8a3e34b02a1e47a8ada140ed2e49a7d7', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_GITHUB: 'https://github.com', // 你的github个人主页
  ...
  TITLE: 'Kingstar BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    'Kingstar BLOG', // 站点描述，被notion中的页面描述覆盖
